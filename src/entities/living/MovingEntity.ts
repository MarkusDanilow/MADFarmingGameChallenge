...
import { MoveCheckResult } from "../../util/BB2D";
...
export class MovingEntity extends Entity {
    ...
    protected animBaseName: string;

    protected latestMoveCheck: MoveCheckResult | undefined = undefined;
    ...
    protected initAnimations(animBaseName: string) {
        ...
        this.animator.addAnimation(`${animBaseName}_${AnimationType.IDLE}_side`, 120);
        this.animator.addAnimation(`${animBaseName}_${AnimationType.RUN}_side`, 120);
    ...
    protected move(deltaTime: number, moveVector: Vector2, map: Map): Vector2 {
        ...
        this.latestMoveCheck = map.entityMoveCheck(this, moveVector);
        moveVector = this.latestMoveCheck.moveVector;
    ...
    public update(deltaTime: number, map: Map): void {
        ...
        this.latestMoveCheck = undefined;
    }
